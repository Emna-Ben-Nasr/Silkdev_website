    ...
    return (
        ...
        <section className="pt-28 min-h-screen bg-gradient-to-b from-[#1D1F34] via-[#163C53] to-[#1D1F34] relative overflow-hidden">
            <div className="relative py-12 px-4 mx-auto max-w-screen-xl text-center lg:py-24 lg:px-12 z-10 -mt-20">
                ...
                >
                    <button
                        className="group relative inline-flex items-center justify-center px-8 py-3 text-lg font-medium text-[#F8F8F9] bg-gradient-to-r from-blue-500 to-blue-700 rounded-lg overflow-hidden shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
                        type="button"
                    >
